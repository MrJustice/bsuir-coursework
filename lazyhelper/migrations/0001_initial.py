# Generated by Django 3.1.2 on 2020-12-14 18:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.FloatField(null=True)),
                ('state', models.CharField(choices=[('Vacant', 'Vacant'), ('In progress', 'In progress'), ('Done', 'Done')], default='Vacant', max_length=12, null=True)),
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='lazyhelper.product')),
            ],
            options={
                'db_table': 'orders',
            },
        ...
        migrations.AddField(
            ...
            name='role',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='lazyhelper.role'),
        ),
        migrations.AddField(
            model_name='customuser',
